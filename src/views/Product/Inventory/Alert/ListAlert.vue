...
import { getTableListApi, delTableListApi, saveTableApi } from '@/api/product/inventory/alert'
import { NotChargedTableData } from '@/api/product/inventory/alert/types'
