...
import { getTableListApi, delTableListApi, saveTableApi } from '@/api/product/request/transfer'
import { NotChargedTableData } from '@/api/product/request/transfer/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  genSearchSchema('datePicker', 'tStartDate', '門店入庫日期', { placeholder: '日期' }),
