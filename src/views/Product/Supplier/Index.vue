...
import { getTableListApi, delTableListApi, saveTableApi } from '@/api/product/supplier'
import { NotChargedTableData } from '@/api/product/supplier/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  { label: '郵編', field: 'postcode' },
  { label: '聯繫電話', field: 'tel' },
  { label: '傳真', field: 'fax' },
  { label: '聯繫人', field: 'fax' },
