...
import { getTableListApi, delTableListApi, saveTableApi } from '@/api/product/ynzj/stockin'
import { NotChargedTableData } from '@/api/product/ynzj/stockin/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  },
  {
    ...
    formatter: function (row) {
      return inDict(row.approveStatus, 'pharmacy.ynzjStatus')
    }
  },
  {
    label: '創建日期',
  ...
  genSearchSchema('input', 'makeId', '製作單號', { placeholder: '製作單號' }),
  genSearchSchema('sourceSelect', 'approveStatus', '狀態', {
    placeholder: '狀態',
    options: dict.pharmacy.ynzjStatus as any
  }),
  genSearchSchema('datePicker', 'startDate', '提交時間', { placeholder: '日期' }),
  genSearchSchema('datePicker', 'endDate', '到', { placeholder: '日期' }),
  genSearchSchema('datePicker', 'approveStartDate', '審核時間', { placeholder: '日期' }),
  genSearchSchema('datePicker', 'approveEndDate', '到', { placeholder: '日期' })
])
