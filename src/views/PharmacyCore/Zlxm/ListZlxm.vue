...
import { getTableListApi, delTableListApi, saveTableApi } from '@/api/pharmacyCore/zlxm'
import { NotChargedTableData } from '@/api/pharmacyCore/zlxm/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  { label: '名稱', field: 'name' },
  { label: '拼音碼', field: 'pinyin' },
  { label: '價格', field: 'price' },
  { label: '報表分類', field: 'reportClass' },
  {
    label: '類別',
    field: 'type',
  ...
  // Search Schema
  genSearchSchema('input', 'name', '名稱', { placeholder: '名稱' }),
  genSearchSchema('sourceSelect', 'type', '所屬類別', {
    placeholder: '類別',
    options: dict.drug.treat as any
  }),
