...
import { getTableListApi, delTableListApi, saveTableApi } from '@/api/pharmacyCore/supplier'
import { NotChargedTableData } from '@/api/pharmacyCore/supplier/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  { label: '名稱', field: 'name', width: '80px' },
  { label: '拼音碼', field: 'pinyinCode', width: '120px' },
  {
    label: '地區',
    field: 'value',
    width: '80px',
  ...
  { label: '郵編', field: 'postcode', width: '80px' },
  { label: '聯繫電話', field: 'tel', width: '80px' },
  { label: '傳真', field: 'fax', width: '150px' },
  { label: '聯繫人', field: 'fax', width: '150px' },
  { label: '創建時間', field: 'createTime', width: '150px' },

  // Search Schema
  genSearchSchema('input', 'name', '供應商名稱', { placeholder: '供應商名稱' })
])
