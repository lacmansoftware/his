...
import { getTableListApi, delTableListApi, saveTableApi } from '@/api/pharmacyCore/store/purchase'
import { NotChargedTableData } from '@/api/pharmacyCore/store/purchase/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  { label: '藥房', field: 'pharmacyName', width: '125px' },
  { label: '供應商', field: 'supplier', width: '125px' },
  {
    label: '狀態',
    field: 'status',
    width: '60px',
  ...
  genSearchSchema('input', 'supplier', '供應商', { placeholder: '供應商' }),
