...
import { getTableListApi, delTableListApi, saveTableApi } from '@/api/pharmacyCore/store/stockin'
import { NotChargedTableData } from '@/api/pharmacyCore/store/stockin/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  { label: '採購計劃編號', field: 'purchaseId', width: '110px' },
  ...
  <ContentWrap>
    ...
    >
      <template #action="{ row }">
        ...
        <div v-else>
          <ElLink type="primary" @click="settlement(row)" class="mr-5px">查看</ElLink>
          <ElLink type="primary" @click="settlement(row)" class="mr-5px">開票管理</ElLink>
        </div>
      </template>
    </Table>
  </ContentWrap>
