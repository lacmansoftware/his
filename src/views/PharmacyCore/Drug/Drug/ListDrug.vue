...
import { getTableListApi, delTableListApi, saveTableApi } from '@/api/pharmacyCore/drug/drug'
import { NotChargedTableData } from '@/api/pharmacyCore/drug/drug/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  genSearchSchema('apiSelect', 'theirPharmacopoeia', '所屬藥典', {
    placeholder: '所屬藥典',
    api: async () => {
      return await getInOptionFormat('sys/dict/type/DrugRegion', 'code', 'undefined')
    }
  }),
...
<template>
  <ContentWrap>
    ...
    <div class="mb-10px ml-10px mt-[-32px]">
      ...
      <ElButton type="primary" @click="AddAction" :icon="plusIcon">第三方藥典轉入</ElButton>
    </div>
