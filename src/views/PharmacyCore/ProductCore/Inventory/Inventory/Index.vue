...
import {
  ...
  delTableListApi,
  saveTableApi
} from '@/api/pharmacyCore/product_core/inventory/inventory'
import { NotChargedTableData } from '@/api/pharmacyCore/product_core/inventory/inventory/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  { label: '商品名稱', field: 'productName', width: '100px' },
  { label: '商品編碼', field: 'productId', width: '60px' },
  ...
  { label: '零售價', field: 'sellingUnitPrice', width: '60px' },
  ...
  genSearchSchema('input', 'productCode', '商品名稱', { placeholder: '商品名稱' }),
