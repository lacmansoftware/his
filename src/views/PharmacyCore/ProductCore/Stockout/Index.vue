...
import {
  ...
  delTableListApi,
  saveTableApi
} from '@/api/pharmacyCore/product_core/stockout'
import { NotChargedTableData } from '@/api/pharmacyCore/product_core/stockout/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  { label: '門店', field: 'hospitalName', width: '100px' },
  { label: '出庫單編號', field: 'id', width: '110px' },
  { label: '入庫單編號', field: 'stockInId', width: '110px' },
  ...
  { label: '門店調撥備註', field: 'transferRemark', width: '90px' },
