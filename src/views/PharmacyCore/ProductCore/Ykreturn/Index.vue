...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  { label: '退貨單號', field: 'id', width: '120px' },
  { label: '供應商', field: 'supplierName', width: '120px' },
  {
    label: '狀態',
    field: 'status',
    width: '60px',
  ...
  // Search Schema
  genSearchSchema('input', 'id', '退貨單號', { placeholder: '退貨單號' }),
  ...
  genSearchSchema('sourceSelect', 'status', '狀態', {
    placeholder: '狀態',
    options: dict.pharmacy.ykReturnStatus as any
  })
])
