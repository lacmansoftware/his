...
import {
  ...
  delTableListApi,
  saveTableApi
} from '@/api/pharmacyCore/inventory/priceChangeLog'
import { NotChargedTableData } from '@/api/pharmacyCore/inventory/priceChangeLog/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  { label: '調整后零售價', field: 'asellingUnitPrice' },
  { label: '調整時總數量', field: 'totalQty' },
  ...
  genSearchSchema('autocomplete', 'drugId', '藥品名稱', {
