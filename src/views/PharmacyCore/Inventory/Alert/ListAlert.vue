...
import { getTableListApi, delTableListApi, saveTableApi } from '@/api/pharmacyCore/inventory/alert'
import { NotChargedTableData } from '@/api/pharmacyCore/inventory/alert/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  { label: '網診開方下限', field: 'minQty', width: '150px' },
  {
    ...
    width: '100px',
    formatter: function (row) {
      return row.pharmacyInventory.totalQty
    }
  },
  {
    label: '可用庫存',
