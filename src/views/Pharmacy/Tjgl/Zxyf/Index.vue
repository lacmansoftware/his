...
import { getTableListApi, delTableListApi, saveTableApi } from '@/api/pharmacy/tjgl/zxyf'
import { NotChargedTableData } from '@/api/pharmacy/tjgl/zxyf/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  { label: '至信訂單號', field: 'zxOrderId', width: '130px' },
  ...
  },
  {
    ...
    field: 'recipelStatus',
    formatter: function (row) {
      if (!row.recipelStatus) {
        return '未退葯'
      }
      return inDict(row.recipelStatus, 'returnDrugStatus')
    }
  },
