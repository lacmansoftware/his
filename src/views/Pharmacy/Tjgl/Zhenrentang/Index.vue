...
import { getTableListApi, delTableListApi, saveTableApi } from '@/api/pharmacy/tjgl/zhenrentang'
import { NotChargedTableData } from '@/api/pharmacy/tjgl/zhenrentang/types'
