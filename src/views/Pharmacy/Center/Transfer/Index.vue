...
import { getTableListApi, delTableListApi, saveTableApi } from '@/api/pharmacy/center/transfer'
import { NotChargedTableData } from '@/api/pharmacy/center/transfer/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  { label: '調撥單號', field: 'id', width: '110px' },
  {
    label: '狀態',
    field: 'status',
    width: '60px',
  ...
  { label: '出庫日期', field: 'approveTime', width: '110px' },
  { label: '出庫審核人', field: 'approver', width: '60px' },
  { label: '藥房入庫日期', field: 'transferTime', width: '110px' },
  { label: '藥房入庫審核人', field: 'transferUser', width: '70px' },
  { label: '中心出庫備註', field: 'remark', width: '130px' },
  { label: '調撥備註', field: 'transferRemark', width: '130px' },

  // Search Schema
  genSearchSchema('datePicker', 'startDate', '中心出庫日期', { placeholder: '日期' }),
  genSearchSchema('datePicker', 'endDate', '到', { placeholder: '日期' }),
  genSearchSchema('input', 'id', '調撥單號', { placeholder: '調撥單號' }),
  genSearchSchema('sourceSelect', 'status', '狀態', {
    placeholder: '狀態',
    options: dict.pharmacy.transferStatus as any
  }),
  genSearchSchema('datePicker', 'tStartDate', '藥房入庫日期', { placeholder: '日期' }),
  genSearchSchema('datePicker', 'tEndDate', '到', { placeholder: '日期' }),
