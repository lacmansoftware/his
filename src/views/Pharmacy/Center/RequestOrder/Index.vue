...
import { getTableListApi, delTableListApi, saveTableApi } from '@/api/pharmacy/center/requestOrder'
import { NotChargedTableData } from '@/api/pharmacy/center/requestOrder/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  { label: '門店', field: 'pharmacyName', width: '120px' },
  ...
  { label: '提交日期', field: 'submitTime', width: '125px' },
