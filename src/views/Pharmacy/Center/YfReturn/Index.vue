...
import { getTableListApi, delTableListApi, saveTableApi } from '@/api/pharmacy/center/yfreturn'
import { NotChargedTableData } from '@/api/pharmacy/center/yfreturn/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  { label: '退藥單號', field: 'id', width: '120px' },
  ...
  { label: '創建日期', field: 'createTime', width: '110px' },
  { label: '創建人', field: 'createUser', width: '60px' },
  { label: '審核時間', field: 'approveTime', width: '110px' },
  { label: '審核人', field: 'approveUser', width: '60px' },
  { label: '備註', field: 'remark', width: '60px' },
