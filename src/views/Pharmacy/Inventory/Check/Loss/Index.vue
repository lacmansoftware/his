...
import { getTableListApi, delTableListApi, saveTableApi } from '@/api/pharmacy/inventory/loss'
import { NotChargedTableData } from '@/api/pharmacy/inventory/loss/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  { label: '審核時間', field: 'approveTime', width: '80px' },
  { label: '審核人', field: 'approveUser', width: '80px' },
  { label: '審核備註', field: 'approveRemark', width: '100px' },

  // Search Schema
  genSearchSchema('input', 'id', '報損單號', { placeholder: '報損單號' }),
