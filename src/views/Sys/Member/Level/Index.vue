...
import { getTableListApi, delTableListApi, saveTableApi } from '@/api/sys/member/level'
import { NotChargedTableData } from '@/api/sys/member/level/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  { label: '級別名稱', field: 'levelName' },
  { label: '優惠體系說明', field: 'remark' },
