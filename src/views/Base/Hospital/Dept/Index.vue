...
import { getTableListApi, delTableListApi, saveTableApi } from '@/api/base/hospital/dept'
import { NotChargedTableData } from '@/api/base/hospital/dept/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  { label: '機構名稱', field: 'deptName' },
  {
    label: '所屬類型',
    field: 'type',
    formatter: function () {
      return userInfo.hospitalName ?? ''
    }
  },
  ...
  // Search Schema
  genSearchSchema('input', 'name', '名稱', { placeholder: '請輸入名稱' })
])
...
<template>
  <ContentWrap>
    ...
    <div class="mb-10px ml-10px mt-[-32px]">
      <ElButton type="primary" @click="AddAction" :icon="plusIcon">新增部門</ElButton>
    </div>
