...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  },
  {
    ...
    formatter: function (row) {
      return inDict(row.inspectStatus, 'checked')
    }
  },
  {
    label: '就診類型',
  ...
  { label: '看診時間', field: 'appointmentTimeStart' },
  { label: '挂號編號', field: 'registerNum' },
  { label: '客人', field: 'memberName' },
  {
    label: '年齡',
    field: 'birthday',
    formatter: function (row) {
