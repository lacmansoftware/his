...
import { getTableListApi, delTableListApi, saveTableApi } from '@/api/market/insur'
import { NotChargedTableData } from '@/api/market/insur/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  { label: '保險公司名稱', width: '99px', field: 'companyName' },
  { label: '產品名稱', field: 'productName', width: '80px' },
  {
    label: '狀態',
    field: 'isActive',
  ...
  { label: '產品說明', field: 'productDesc', width: '80px' },
  { label: '實用門店', field: 'hospitalName', width: '80px' },
  { label: '創建時間', field: 'createTime', width: '80px' },
  { label: '更新時間', field: 'modifyTime', width: '150px' },
  { label: '更新人', field: 'modifyUser', width: '150px' }
])
...
<template>
  <ContentWrap>
    ...
    >
      <template #action="{ row }">
        <div v-if="row.isActive === 'Y'">
          <ElLink type="primary" @click="settlement(row)" class="mr-5px">停用</ElLink>
