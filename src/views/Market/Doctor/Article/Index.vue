...
import { getTableListApi, delTableListApi, saveTableApi } from '@/api/market/doctor/article'
import { NotChargedTableData } from '@/api/market/doctor/article/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  // Search Schema
  genSearchSchema('input', 'title', '標題', { placeholder: '標題' }),
  genSearchSchema('input', 'keywords', '醫生姓名/手機', { placeholder: '醫生姓名/手機' }),
  genSearchSchema('datePicker', 'startTm', '日期', { placeholder: '日期' }),
  ...
  <ContentWrap>
    ...
    >
      <template #action="{ row }">
        ...
        <ElLink type="primary" @click="settlement(row)" class="mr-5px">預覽</ElLink>
