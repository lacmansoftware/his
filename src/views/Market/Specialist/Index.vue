...
import { getTableListApi, delTableListApi, saveTableApi } from '@/api/market/specialist'
import { NotChargedTableData } from '@/api/market/specialist/types'
...
const crudSchemas = reactive<CrudSchema[]>([
  ...
  { label: '門診專科名稱', field: 'specialistName' },
  ...
  // Search Schema
  genSearchSchema('input', 'specialistName', '專科名稱', { placeholder: '專科名稱' }),
